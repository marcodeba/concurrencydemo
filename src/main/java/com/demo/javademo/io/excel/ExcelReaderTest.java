...
//			config.setColStartPosittion(1);
        ...
        logger.info("路径:{}", this.getClass().getClassLoader().getResource("TestSpuidsFor.xlsx").getPath());
        excel.InitExcelReader(this.getClass().getClassLoader().getResource("TestSpuidsFor.xlsx").getPath());
